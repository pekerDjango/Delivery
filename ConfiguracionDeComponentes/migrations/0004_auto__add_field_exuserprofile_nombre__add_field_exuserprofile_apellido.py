...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExUserProfile.nombre'
        db.add_column(u'ConfiguracionDeComponentes_exuserprofile', 'nombre',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length='30'),
                      keep_default=False)

        # Adding field 'ExUserProfile.apellidos'
        db.add_column(u'ConfiguracionDeComponentes_exuserprofile', 'apellidos',
                      self.gf('django.db.models.fields.CharField')(default='q', max_length='100'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExUserProfile.nombre'
        db.delete_column(u'ConfiguracionDeComponentes_exuserprofile', 'nombre')

        # Deleting field 'ExUserProfile.apellidos'
        db.delete_column(u'ConfiguracionDeComponentes_exuserprofile', 'apellidos')
