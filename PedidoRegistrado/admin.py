...
from PedidoRegistrado.models import Servicio, TipologiaVivienda, \
    DomicilioSearch, Cliente, EstadoPedido, Pedido, DetallePedido, \
    VersionProducto, ProductoParaArmar, SeccionProducto, IngredientesSeccion, \
    IngredienteClasificacion
...
class ServicioAdmin(admin.ModelAdmin):
    ...
    formfield_overrides = {models.CharField: {'widget':
                                            TextInput(attrs={'size': '100'})},
...
class DomicilioSearchAdmin(admin.ModelAdmin):
    list_display = ('barrio', 'direccion', 'numero_direccion', 'depto', 'piso',
                    'localidad', 'codigo_postal')
    list_filter = ('direccion', 'numero_direccion', 'piso', 'depto',
...
class ClienteAdmin(admin.ModelAdmin):
    list_display = ('apellido', 'nombre', 'sexo', 'email',
                    'telefono_particular')
    list_filter = ('nombre', 'apellido', 'sexo', 'email',
                   'telefono_particular')
    ordering = ('apellido',)
...
class PedidoAdmin(admin.ModelAdmin):
    search_fields = ('cliente', 'fechaPedido', 'estado', 'servicio',
                     'tipologia_vivienda')
    list_display = ('cliente', 'fechaPedido', 'domicilio', 'hora_entrega',
                    'servicio', 'tipologia_vivienda', 'precio_envio', 'estado')
    list_filter = ('cliente', 'fechaPedido', 'hora_entrega', 'estado',
                   'servicio', 'tipologia_vivienda', 'precio_envio')
...
class ProductoParaArmarAdmin(admin.ModelAdmin):
    ...
    # IngredientesSeccionProductoInline]
...
#    fields =('codigo','nombre', 'tiempoPreparacion', 'tipoProducto',
# 'version','estado')
