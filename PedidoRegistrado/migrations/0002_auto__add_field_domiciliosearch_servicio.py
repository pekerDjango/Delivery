...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomicilioSearch.servicio'
        db.add_column(u'PedidoRegistrado_domiciliosearch', 'servicio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['PedidoRegistrado.Servicio']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomicilioSearch.servicio'
        db.delete_column(u'PedidoRegistrado_domiciliosearch', 'servicio_id')
