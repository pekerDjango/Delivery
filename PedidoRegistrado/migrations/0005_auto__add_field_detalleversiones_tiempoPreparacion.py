...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetalleVersiones.tiempoPreparacion'
        db.add_column(u'PedidoRegistrado_detalleversiones', 'tiempoPreparacion',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetalleVersiones.tiempoPreparacion'
        db.delete_column(u'PedidoRegistrado_detalleversiones', 'tiempoPreparacion')
