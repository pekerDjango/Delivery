...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetalleVersiones.imagenProducto'
        db.add_column(u'PedidoRegistrado_detalleversiones', 'imagenProducto',
                      self.gf('django.db.models.fields.files.ImageField')(default='sada.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetalleVersiones.imagenProducto'
        db.delete_column(u'PedidoRegistrado_detalleversiones', 'imagenProducto')
