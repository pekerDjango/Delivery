...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IngredienteClasificacion'
        db.create_table(u'PedidoRegistrado_ingredienteclasificacion', (
        ...
        db.send_create_signal(u'PedidoRegistrado', ['IngredienteClasificacion'])

        # Deleting field 'IngredientesSeccion.cantidad'
        db.delete_column(u'PedidoRegistrado_ingredientesseccion', 'cantidad')

        # Deleting field 'IngredientesSeccion.clasificacion'
        db.delete_column(u'PedidoRegistrado_ingredientesseccion', 'clasificacion_id')


    def backwards(self, orm):
        # Deleting model 'IngredienteClasificacion'
        db.delete_table(u'PedidoRegistrado_ingredienteclasificacion')


        # User chose to not deal with backwards NULL issues for 'IngredientesSeccion.cantidad'
        raise RuntimeError("Cannot reverse this migration. 'IngredientesSeccion.cantidad' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'IngredientesSeccion.clasificacion'
        raise RuntimeError("Cannot reverse this migration. 'IngredientesSeccion.clasificacion' and its values cannot be restored.")
