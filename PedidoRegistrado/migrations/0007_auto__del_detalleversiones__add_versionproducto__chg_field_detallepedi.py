...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VersionProducto'
        db.create_table(u'PedidoRegistrado_versionproducto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('clasificacion', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'pedidoregistrado_versionproducto_related', to=orm['ComponentesDePedido.Clasificacion'])),
        ...
        db.send_create_signal(u'PedidoRegistrado', ['VersionProducto'])
        ...
        # Changing field 'ProductoArmado.version'
        db.alter_column(u'PedidoRegistrado_productoarmado', 'version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PedidoRegistrado.VersionProducto']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'VersionProducto'
        db.delete_table(u'PedidoRegistrado_versionproducto')
        ...
        # Changing field 'ProductoArmado.version'
        db.alter_column(u'PedidoRegistrado_productoarmado', 'version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PedidoRegistrado.DetalleVersiones']))
