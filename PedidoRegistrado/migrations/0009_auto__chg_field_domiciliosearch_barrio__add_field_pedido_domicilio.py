...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DomicilioSearch.barrio'
        db.alter_column(u'PedidoRegistrado_domiciliosearch', 'barrio_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['RecursosDeEmpresa.Barrio']))
        # Adding field 'Pedido.domicilio'
        db.add_column(u'PedidoRegistrado_pedido', 'domicilio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['PedidoRegistrado.DomicilioSearch']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DomicilioSearch.barrio'
        db.alter_column(u'PedidoRegistrado_domiciliosearch', 'barrio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['RecursosDeEmpresa.Barrio']))
        # Deleting field 'Pedido.domicilio'
        db.delete_column(u'PedidoRegistrado_pedido', 'domicilio_id')
    ...
    models = {
        ...
        u'PedidoRegistrado.domiciliosearch': {
            ...
            'barrio': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': u"orm['RecursosDeEmpresa.Barrio']"}),
        ...
        u'PedidoRegistrado.pedido': {
            ...
            'domicilio': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['PedidoRegistrado.DomicilioSearch']"}),
        ...
        u'PedidoRegistrado.productoarmado': {
            ...
            'version': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['PedidoRegistrado.VersionProducto']"})
        },
        ...
        u'PedidoRegistrado.versionproducto': {
            'Meta': {'object_name': 'VersionProducto'},
            'clasificacion': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'pedidoregistrado_versionproducto_related'", 'to': u"orm['ComponentesDePedido.Clasificacion']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagenProducto': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'precio': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            'producto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['PedidoRegistrado.ProductoParaArmar']"}),
